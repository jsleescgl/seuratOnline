                                 ...
                                 tabsetPanel(type = "tabs",
                                             tabPanel("Find markers by cluster", 
                                                      ...
                                                      column(12,
                                                             wellPanel(
                                                               ...
                                                               column(4,selectInput("clusterNum", "Cluster Num", 
                                                                                    choices = c(1,2,3,4), selected = 1)),
                                                               column(4,numericInput("minPct", "Min %", value = 0.25)),
                                             ...
                                             tabPanel("Find markers by cluster vs other clusters", 
                                                      column(12,
                                                             wellPanel(
                                                               ...
                                                               column(3,numericInput("minPctvs", "Min %", value = 0.25)),
                                             ...
                                             tabPanel("Find all markers", 
                                                      column(12,
                                                             wellPanel(
                                                               h4("Find All Markers:"),
                                                               column(4,numericInput("minPctAll", "Min %", value = 0.25)),
